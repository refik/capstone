...
Blogs are different then news. Shortests blog documents occur most frequently
and increasing word count means less frequent occurance. My understanding is 
that people try to write shorter blog posts.
...
are inspected for this purpose. Words like "the", "and" is filtered out.

It is interesting to see that top 3 words are same for 3 different types of 
documents. Twitter documents top 10 words have higher relative frequency
than the other two types of documents. 
